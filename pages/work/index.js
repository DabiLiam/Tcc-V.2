        ...
        <div className='flex flex-col xl:flex-row gap-x-8'>
          ...
          <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
            ...
            <motion.p variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit="hidden" className='mb-4 max-w-[400px] mx-auto lg:mx-0'>
              Alguns dos meus trabalhos e projetos feitos durante meus estudos e carreira free lancer.
            </motion.p>
          </div>

          {/* slider */}
          <motion.div variants={fadeIn('down', 0.6)} initial="hidden" animate="show" exit="hidden" className='w-full xl:max-w-[65%] mr-16'>
          <WorkSlider />
          </motion.div>
        </div>
      </div>
